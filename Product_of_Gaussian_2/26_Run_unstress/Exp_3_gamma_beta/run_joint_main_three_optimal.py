...
if __name__ == '__main__':
    ...
    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/Syllable_level/B_other_coeff/testrun/out_all/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[training_size], data_dict[training_size], block_size, block_size)

    zero_coeff_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/Syllable_level/A_zeroth_coeff/testrun/out_all/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[training_size], data_dict[training_size], block_size, block_size)
    ...
    method = '/Exp_3/Syllable_training_size_{}/block_size_{}/num_coeff_{}/tone_{}/'.format(training_size, block_size, num_coeff, tone)
