...
# set tone=0
# /usr/local/bin/python -u ./run_joint_main.py -startbeta 0.1 -endbeta 2.0 -tone $tone -stress_or_unstress unstress -num_coeff $num_coeff -block_size 256 -training_size $training_size >! ./log_Exp_4/log.tone.$tone.$training_size.txt 
