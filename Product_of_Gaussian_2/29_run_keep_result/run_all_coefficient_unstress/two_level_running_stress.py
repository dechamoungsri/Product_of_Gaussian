...
if __name__ == '__main__':
    ...
    training_size = 450
    num_coeff = 3
    mainoutpath = '/29_script/Exp_4_stress_all_coeff/'

    syllable_predicted_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/04_syllable_level_3_dct/testrun/out/tsc/'
