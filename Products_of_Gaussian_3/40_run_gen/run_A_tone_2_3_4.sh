...
-method_name Stress_Method_A_phone \
...
-training_size 250 -tone 2 -stress_type 1 -tone_folder all >! ./log/log_ph_A_tone_2.txt
...
-start_syl_1toN 0.0 -end_syl_1toN 0.1 \
-start_syl_0 0.0 -end_syl_0 0.1 \
-training_size 250 -tone 3 -stress_type 1 -tone_folder all >! ./log/log_ph_A_tone_3.txt
...
-start_syl_1toN 0.0 -end_syl_1toN 0.1 \
-start_syl_0 0.0 -end_syl_0 0.1 \
-training_size 250 -tone 4 -stress_type 1 -tone_folder all >! ./log/log_ph_A_tone_4.txt
