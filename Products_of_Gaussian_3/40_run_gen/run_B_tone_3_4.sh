...
# -training_size 250 -tone 3 -stress_type 1 -tone_folder all >! ./log/log_ph_B_tone_3.txt
...
-start_syl_0 0.0 -end_syl_0 2.0 \
-training_size 250 -tone 4 -stress_type 1 -tone_folder all >! ./log/log_ph_B_tone_4.txt
