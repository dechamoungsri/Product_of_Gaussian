...
-training_size 250 -tone 0 -stress_type 1 -tone_folder all >! ./log/log_ph_A_tone_0.txt
...
-start_syl_1toN 0.0 -end_syl_1toN 0.1 \
-start_syl_0 0.0 -end_syl_0 0.1 \
-training_size 250 -tone 1 -stress_type 1 -tone_folder all >! ./log/log_ph_A_tone_1.txt
