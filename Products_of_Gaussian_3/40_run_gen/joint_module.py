...
class JointModule(object):
    ...
    @staticmethod
    def gen_W(number_of_frame, dur_list, num_coeff, stress_list, vuv, tone, stress_type, p_in_s_file, use_consonant=False):
        ...
        for idx, (d, p_in_s, st) in enumerate(zip(dur_list, p_in_s_file, stress_list)):
    ...
    @staticmethod
    def generate_DCT_W(number_of_frame, dur_list, num_coeff, stress_list, vuv, tone, stress_type, p_in_s_file, use_consonant=False):
        all_w = JointModule.gen_W(number_of_frame, dur_list, num_coeff, stress_list, vuv, tone, stress_type, p_in_s_file, use_consonant=use_consonant)
    ...
    @staticmethod
    def cal_suprasegmental(level, config, coeff_end_position, coeff_start_position=0, use_consonant=False, const=1.0):
        ...
        w = JointModule.generate_DCT_W(number_of_frame, dur_list, num_coeff, stress_list, vuv, tone, stress_type, p_in_s_file, use_consonant=use_consonant)
