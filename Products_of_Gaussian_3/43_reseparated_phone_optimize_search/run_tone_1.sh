...
-start_ph_0 9.8 -end_ph_0 20.0 \
-start_syl_1toN 0.7 -end_syl_1toN 0.7 \
-start_syl_0 0.0 -end_syl_0 0.0 \
-increment 0.1 \
-phone_type $phone_type \
-training_size 250 -tone $tone -stress_type 1 -tone_folder all >! ./$log/log_ph_C_tone_$tone'_d.txt'
