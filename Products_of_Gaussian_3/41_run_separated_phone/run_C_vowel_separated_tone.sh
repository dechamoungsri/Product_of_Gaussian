...
set log='./log_'$today'_'$phone_type'_'tone_separated'/'
...
-method_name Stress_Method_C_phone_tone_separated \
...
-training_size 250 -tone $tone -stress_type 1 -tone_folder $tone >! ./$log/log_ph_C_tone_$tone.txt
