...
set log='./log_phone_and_syllable_'$today'_'$phone_type'_'tone_separated'/'
...
-start_ph_0 0.0 -end_ph_0 0.1 \
-start_syl_1toN 6.0 -end_syl_1toN 10.0 \
-start_syl_0 0.0 -end_syl_0 0.1 \
-phone_type $phone_type \
-training_size 250 -tone $tone -stress_type 1 -tone_folder $tone >! ./$log/log_ph_C_tone_$tone'_6-10.txt'
