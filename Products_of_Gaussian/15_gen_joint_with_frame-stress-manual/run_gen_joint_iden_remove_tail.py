...
def cal_lf0(config):
    ...
    syl_w = PoGUtility.generate_DCT_W_without_consonant_on_stress_vuv(len(lf0_cov), dur_list, num_coeff, p_in_s_file, stress, vuv)
...
if __name__ == '__main__':
    ...
    method = '05e_stress_only_iden_cov_remove_tail'
