...
def cal_lf0(config):
    ...
    syl_w = PoGUtility.generate_DCT_W_with_vuv_without_consonant(len(lf0_cov), dur_list, num_coeff, vuv, p_in_s_file)
...
if __name__ == '__main__':
    ...
    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/02_syllable_level_4dct/testrun/out/tsc/{}/infer/{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(training_size, training_size, block_size, block_size)
    ...
    for b in np.arange(start, end, increment):
        ...
        outbase = '/work/w21/decha/Interspeech_2017/Result/02_no_consonant_weight_{}/{}/num_dct_cov_{}/'.format(block_size, training_size, num_coeff)
