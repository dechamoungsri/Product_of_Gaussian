...
if __name__ == '__main__':
    ...
    method = '03_syllable_level_4dct_5_to_40_frames'

    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/{}/testrun/out/tsc/a-i/infer/a-i/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(method, block_size, block_size)
    ...
    for b in np.arange(start, end, increment):
        ...
        outbase = '/work/w21/decha/Interspeech_2017/Result/{}_weight_{}/num_dct_cov_{}/'.format(method, block_size, num_coeff)
