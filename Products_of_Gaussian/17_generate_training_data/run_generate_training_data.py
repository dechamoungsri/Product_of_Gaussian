...
if __name__ == '__main__':
    ...
    for coeff in [3, 4, 7]:
        ...
        Utility.save_obj(syl_dct, '/work/w2/decha/Data/GPR_speccom_data/Interspeech2017/tone_separated/tone_all_dct_coeff_{}.pkl'.format(coeff))

        for t in range(5):

            print t, len(tone_dct_dict[t])

            Utility.save_obj(tone_dct_dict[t], '/work/w2/decha/Data/GPR_speccom_data/Interspeech2017/tone_separated/tone_{}_dct_coeff_{}.pkl'.format(t, coeff))
