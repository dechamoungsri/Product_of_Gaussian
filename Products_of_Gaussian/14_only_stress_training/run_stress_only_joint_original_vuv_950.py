...
if __name__ == '__main__':
    ...
    method = '04-950-b_stress_only_original_vuv'

    outname = '/work/w21/decha/Interspeech_2017/Result/{}_block_{}/'.format(method, block_size)

    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/04_syllable_level_3_dct/testrun/out/tsc/a-t/infer/a-t/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(block_size, block_size)
    ...
    for a in np.arange(start, end, increment):
