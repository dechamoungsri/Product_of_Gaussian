...
def cal_lf0(config):
    ...
    syl_w = PoGUtility.generate_DCT_W_without_consonant_on_stress_vuv_head_tail(len(lf0_cov), dur_list, num_coeff, p_in_s_file, stress, vuv)
...
if __name__ == '__main__':
    ...
    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/05_syllable_level_3_dct_no_zeroth/testrun/out_{}/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(tone, data_dict[950], data_dict[950], block_size, block_size)
