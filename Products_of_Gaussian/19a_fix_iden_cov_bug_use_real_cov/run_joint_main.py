...
if __name__ == '__main__':
    ...
    method = '/C_Remove_zeroth_from_all_use_real_cov/Syllable_training_size_{}/block_size_{}/num_coeff_{}/tone_{}/'.format(training_size, block_size, num_coeff, tone)
    # method = '/E_both_stress-unstress_from_02_syllable_level/Syllable_training_size_{}/block_size_{}/num_coeff_{}/tone_{}/'.format(training_size, block_size, num_coeff, tone)
