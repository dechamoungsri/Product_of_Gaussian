...
/usr/local/bin/python -u ./run_joint_main_change_GPR_training.py 3 256 950 0 0.1 2.0 no_plot stress_only >! ./log_D2/log_4-256-950-0.txt &
/usr/local/bin/python -u ./run_joint_main_change_GPR_training.py 3 256 950 1 0.1 2.0 no_plot stress_only >! ./log_D2/log_4-256-950-1.txt &
/usr/local/bin/python -u ./run_joint_main_change_GPR_training.py 3 256 950 2 0.1 2.0 no_plot stress_only >! ./log_D2/log_4-256-950-2.txt &
/usr/local/bin/python -u ./run_joint_main_change_GPR_training.py 3 256 950 3 0.1 2.0 no_plot stress_only >! ./log_D2/log_4-256-950-3.txt &
/usr/local/bin/python -u ./run_joint_main_change_GPR_training.py 3 256 950 4 0.1 2.0 no_plot stress_only >! ./log_D2/log_4-256-950-4.txt &
