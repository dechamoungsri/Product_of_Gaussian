...
if __name__ == '__main__':
    ...
    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/05_syllable_level_3_dct_no_zeroth/testrun/out_all/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[950], data_dict[950], block_size, block_size)
    # syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/02_syllable_level_4dct/testrun/out/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[950], data_dict[950], block_size, block_size)

    zero_coeff_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/06_zeroth_coeff_run_tree_05/testrun/out_all/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[950], data_dict[950], block_size, block_size)

    mask = 'gen'

    method = '/F_two_optimal_value/Syllable_training_size_{}/block_size_{}/num_coeff_{}/tone_{}/'.format(training_size, block_size, num_coeff, tone)
    ...
    # for (b, g) in itertools.product(np.arange(start, end, increment), np.arange(gamma_start, gamma_end, increment)) :

    for b in np.arange(start, end, increment):
        old_rmse = 100000000.0
        for g in np.arange(start, end, increment):
