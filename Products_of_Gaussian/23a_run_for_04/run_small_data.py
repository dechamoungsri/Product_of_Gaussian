...
if __name__ == '__main__':
    ...
    use_partial_coeff = False
    if len(sys.argv) >= 10:
        if sys.argv[9] == 'use_partial_coeff':
            use_partial_coeff = True
    ...
    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/04_syllable_level_3_dct/testrun/out/tsc/a-{}/infer/a-{}/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(data_dict[training_size], data_dict[training_size], block_size, block_size)
    ...
    method = '/C4-250-frame-utterance_04_syllable_level_3_dct/Syllable_training_size_{}/block_size_{}/num_coeff_{}/tone_{}/'.format(training_size, block_size, num_coeff, tone)
