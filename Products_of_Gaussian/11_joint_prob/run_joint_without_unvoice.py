...
if __name__ == '__main__':
    ...
    method = '03_syllable_level_4dct_5_to_40_frames_no_vuv_mask'

    outname = '/work/w21/decha/Interspeech_2017/Result/{}_block_{}_with_consonant/'.format(method, block_size)

    syllable_predicted_dct_path = '/work/w21/decha/Interspeech_2017/Speech_synthesis/03_syllable_level_4dct_5_to_40_frames/testrun/out/tsc/a-i/infer/a-i/demo/seed-00/M-{}/B-{}/num_iters-5/dur/predictive_distribution/'.format(block_size, block_size)
