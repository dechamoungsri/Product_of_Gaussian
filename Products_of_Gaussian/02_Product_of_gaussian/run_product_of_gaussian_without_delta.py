...
def cal_PoG(config):
    ...
    lf0_mean = np.load('{}/mean.npy'.format(base_path))[:,0]
    lf0_mean = lf0_mean.reshape(len(lf0_mean),1)
...
if __name__ == '__main__':
    ...
    outpath = '/work/w21/decha/Interspeech_2017/Result/02_Given_syllable_dct_without_delta/num_dct_cov_{}/'.format(num_coeff)
