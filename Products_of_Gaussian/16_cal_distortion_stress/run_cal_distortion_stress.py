...
if __name__ == '__main__':
    ...
    for i in np.arange(0.1, 2.1, 0.2):
        ...
        # syn = '/work/w21/decha/Interspeech_2017/Result/05c_stress_only_iden_cov_block_256/num_dct_cov_3/Beta_{}/lf0/'.format(i)

        #Best
        syn = '/work/w21/decha/Interspeech_2017/Result/05f_stress_only_iden_cov_remove_head_tail_block_256/num_dct_cov_3/Beta_{}/lf0/'.format(i)
